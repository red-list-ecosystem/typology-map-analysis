DROP FUNCTION IF EXISTS rle_intersection_size_vectors2;

CREATE OR REPLACE FUNCTION rle_intersection_size_vectors2(
  poly Geometry,
  realm varchar,
  biome varchar,
  layer varchar,
...
END;
$function$;
COMMENT ON FUNCTION rle_intersection_size_vectors2 IS 'Query vector layers that intersect with given polygon geometry';
